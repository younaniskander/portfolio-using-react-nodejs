...
function Home() {
  ...
  return (
    ...
    <div id="home-div">
      ...
      <h1 className="h1 three-second-animation" >Younan Iskander</h1>
      <h2 className="h2 five-second-animation" >I'm a AI Engineer</h2>
      <Link to='/resume' exact className="p seven-second-animation" id="intro" >
        <p className="p seven-second-animation" id="intro" >I have experience in ML, NLP, DAX, and more.</p>
      </Link>
