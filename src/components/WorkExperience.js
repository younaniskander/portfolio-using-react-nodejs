    ...
    return (
      ...
      <div className="one-second-animation" >
          ...
          <div className="individual-resume-divs" id="showMarketHallCaterers" onClick={this.handleExpand} >
            ...
            <h3 className="h3" id="showMarketHallCaterers" onClick={this.handleExpand} >Overview of Data Tools and Languages
            </h3>
            <h4 className="h4" id="showMarketHallCaterers" onClick={this.handleExpand} >IBM SkillsBuild</h4>
            <h4 className="h4" id="showMarketHallCaterers" onClick={this.handleExpand} >2024</h4>
            ...
            {this.state.showMarketHallCaterers === true ? 
              <div className="resume-bullet-points-div" >
                <p className="resume-bullet-points" >• Recognize the value of collaborating and using open source in the field of data science

</p>
                <p className="resume-bullet-points" >• Identify the purpose of GitHub</p>
                <p className="resume-bullet-points" >• Identify the purpose of a selection of common tools to analyze and visualize data, including:
</p>
                <p className="resume-bullet-points" >• Microsoft Excel - Google Sheets - Structured Query Language (SQL) - Python - IBM Watson Studio - Tableau - Matplotlib</p>
